...
// The PM's own ad-hoc surveys, answered one at a time — opened from the
// header's account menu (see Header.jsx) rather than a floating page nudge.
export function SurveyAnswerModal({ survey, onClose, onAnswered }) {
  ...
  return (
    <Modal title={survey.title} onClose={onClose}>
      <div className="thin-scroll max-h-[60vh] space-y-5 overflow-y-auto overscroll-contain pr-1">
